...
export const executeInput = (entity: Entity, keyMask: number) => {
...
const updateRotation = (physics: CPhysics, keyMask: number) => {
  let dir = 0;
...
const updateThrottle = (throttle: CThrottle, mass: number, keyMask: number) => {
